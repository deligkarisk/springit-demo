...
import com.kosmas.springit.service.CommentService;
import com.kosmas.springit.service.LinkService;
...
public class LinkController {
    ...
    public String createLink(@Valid Link link, BindingResult bindingResult, Model model, RedirectAttributes redirectAttributes) {
        if (bindingResult.hasErrors()) {
            ...
            // In case the validation fails the next line ensures that when the user is redirected to the
            // submission page the inputted values will remain (rather than showing a new empty page)
